...
python -u src/DiT_trainer.py --set num_epochs=800 --set low_rank_pretraining=True --set timestep_conditioning=True 2>&1 | tee tmux_log/$(date +%m%d)/output_log_${timestamp}.txt
