...
class TrainingConfig:
    ...
    training_timestep_lower_bound: int = 0
    training_timestep_upper_bound: int = 1000
    ...
    curriculum_learning_patience: int = 10
    ...
    real_features_path: str = "data/fid_features/CelebA_train_299_fp64.pt"
