...
def load_training_runs_config():
    ...
    training_runs = {
        ...
        # "V galore KD 50":{DiT20250826_211530
        ...
        # "full rank full model fix start low 44 gradual 120 preview 0.05 - 0.1":{
        #     "folder": "DiT20250825_125401",
        #     "checkpoints": ["0014", "0029", "0044", "0059", "0074", "0089", "0104", "0119"]
        # },


        # "full rank full model baseline":{
        #     "folder": "DiT20250825_125418",
        #     "checkpoints": ["0014", "0029", "0044", "0059", "0074", "0089", "0104", "0119"]
        # },
        ...
        # "low rank adaptive":{
        #     "folder": "DiT20250825_211908",
        #     "checkpoints": ["0014","0044", "0074", "0104", "0164", "0224", "0284", "0344", "0404", "0464", "0524", "0584", "0644"]
        #     # "checkpoints": ["0014", "0029", "0044"]
        # },

        # "low rank baseline":{
        #     "folder": "DiT20250825_214018",
        #     "checkpoints": ["0014","0044", "0074", "0104", "0164", "0224", "0284", "0344", "0404", "0464", "0524", "0584", "0644", "0674", "0704"]
        #     # "checkpoints": ["0014", "0029", "0044"]
        # },

        # "low rank full dataset first 3 adaptive":{
        #     "folder": "DiT20250826_065948",
        #     "checkpoints": ["0049","0099", "0149", "0199", "0249", "0299", "0349", "0399", "0449", "0499", "0549", "0599", "0649", "0699"]
        # },

        # "low rank adaptive cosine scheduler":{
        #     "folder": "DiT20250826_121909",
        #     "checkpoints": ["0014", "0029", "0044", "0059", "0074", "0089", "0104", "0119", "0134", "0149", "0164", "0179", "0194", "0209", "0224", "0239"]
        # },

        # "low rank full dataset full model baseline":{
        #     "folder": "DiT20250705_203056",
        #     "checkpoints": ["0099", "0199", "0299"]
        #     # "checkpoints": ["0014", "0029", "0044"]
        # },
        ...
        # "low rank adaptive match activated":{
        #     "folder": "DiT20250826_210755",
...
def main():
    ...
    for run_name, run_config in training_runs.items():
        ...
        for checkpoint in run_config["checkpoints"]:
            ...
            print(f"adaptive in run_name.lower(): {'adaptive' in run_name.lower()}")
            if "adaptive" in run_name.lower():

                if "first" in run_name.lower():
                    number = run_name.split(" ")[-1]
                    number = int(number)
                    print(f"number of first {number} layers is: {number}")
                    config.timestep_conditioning_first_n_blocks = number
                if "last" in run_name.lower():
                    number = run_name.split(" ")[-1]
                    number = int(number)
                    print(f"number of last {number} layers is: {number}")
            ...
            if "adaptive" in run_name.lower():
                ...
                print("added timestep conditioned wrapper")
